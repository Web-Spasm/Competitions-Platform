...
class UnitTests(unittest.TestCase):
    ...
    def test_notification_get_json(self):
        ...
        db.create_all()
        notification = Notification(1, "Ranking changed!")
        self.assertDictEqual(notification.get_json(), {"date": None, "id": None, "student_id": 1, "notification": "Ranking changed!"})
...
class StudentIntegrationTests(unittest.TestCase):
    ...
    def test2_display_notification(self):
        ...
        update_ratings(mod.username, comp2.name)
        update_rankings(comp2)
        self.assertDictEqual(display_notifications("james"), {
              "notifications": [
                  {"ID": 1, "Notification": "RANK : 1. Congratulations on your first rank!"},
                  {"ID": 7, "Notification": "RANK : 1. Well done! You retained your rank after competition Hacker Cup"}
              ]
        })
